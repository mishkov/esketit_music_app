...
class BottomPlayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final playerContent = BlocBuilder<PlayerBloc, PlayerState>(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        selectedTrack?.name ?? l10n.bottomPlayerNoTrackSelected,
    ...
    return SafeArea(
      minimum: EdgeInsets.only(left: 5, right: 5, bottom: 5),
      child: BottomPlayerProgressBorder(
        child: Card.filled(
